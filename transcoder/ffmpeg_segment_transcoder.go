...
func (t *FFMpegSegmentTranscoder) Transcode(fname string) ([][]byte, string, string, error) {
	//Invoke ffmpeg
	contents := ""
	subtitles := ""
	contents, subtitles, err := ffmpeg.Transcode(fname, t.workDir, t.parallelid, t.gpuid, t.tProfiles)
	if err != nil {
		glog.Errorf("Error transcoding: %v", err)
		return nil, contents, subtitles, err
	}
	...
	return dout, contents, subtitles, nil
}
